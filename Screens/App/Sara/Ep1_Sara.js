                    ...
                    Object.entries(commentsAdmin).map(([id, value]) => (
                            <View style={{flexDirection:'row', marginLeft: '10%', marginRight: '10%', marginBottom: '5%'}}>
                                ...
                                <View style={{flexDirection: 'row', alignSelf: 'flex-end'}}>
                                    ...
                                    <TouchableOpacity 
                                     style={{width: '20%', marginTop: '3.90%'}}
                                    onPress={() => {setReprovado(id)}}>
                                        <Text style={{textDecorationLine: 'underline', fontWeight: 'bold', fontSize: 13}}>Recusar</Text>
                                    </TouchableOpacity>
                                    ...
                                    onPress={() => {setAprovado(id)}}>
                                        <Svg marginRight="10%" width="61" height="31" viewBox="0 0 73 37" fill="none" xmlns="http://www.w3.org/2000/svg">
